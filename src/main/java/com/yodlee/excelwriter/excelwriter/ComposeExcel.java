...
public class ComposeExcel<ExcelVo> {
    ...
    private Class<ExcelVo> excelVo;
    private Map<String,Integer> headerRowMapper = new HashMap<>();
    private AtomicInteger rowNum = new AtomicInteger();

    private ComposeExcel(File excelFile, Class<ExcelVo> excelVoClass) throws IOException {
    ...
    public ComposeExcel(String excelFilePath, Class<ExcelVo> excelVoClass) throws IOException{
        this(new File(excelFilePath), excelVoClass);
    }

    public void renderData(List<ExcelVo> excelVoList) throws ExcelWriterException {
        getExcelVoFields();
        createHeaderRow();
        generateExcelRows(excelVoList);
    }

    private void generateExcelRows(List<ExcelVo> excelVoList) throws ExcelWriterException {
    ...
    private void populateExcelRows(Row row, ExcelVo excelVo) throws ExcelWriterException {
